...
if __name__ == '__main__':
    def semantic_extraction():
        ...
        with open('/home/giacomo/PycharmProjects/ast_generator/Docs/contracts.csv', 'w', newline='') as file:
            ...
            parser.semantic_extraction('/home/giacomo/PycharmProjects/ast_generator/Not_Smart_Ponzi AST/')
    ...
    parser.semantic_extraction('/home/giacomo/PycharmProjects/ast_generator/Ponzi_Abstract_Syntax_Trees/')
    semantic_extraction()
